<%@ Page Title="Service" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="services.aspx.cs" Inherits="Assignment01.services" %>
                        ...
                        <div role="tabpanel" class="tab-pane active" id="home">
                            <table style="margin-top:50px;padding:30px">
                                <tr>
                                    ...
                                    <td> Providing service of generating website by using HTML,CSS,ASP.NET,JavasScript. Validating the form input and operating the data of functionality in the back end  </td>
                                </tr>
                        ...
                        <div role="tabpanel" class="tab-pane" id="messages">
                            <table style="margin-top:50px;padding:30px">
                                <tr>
                                    ...
                                    <td>Creating the structure of database basing on specific business rules.Having strong ability to analyze the problem and generate effective idea of domain class.Mastering the SQL language to maintain database. </td>
                                </tr>
